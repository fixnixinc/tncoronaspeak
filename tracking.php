...
<tbody>
  <td><?php echo $rows['id'];?></td>
   <td><?php echo $rows['district'];?></td>
    <td><?php echo $rows['datepicker'];?></td>
     <td><?php echo $rows['sampletest'];?></td>
      <td><?php echo $rows['casepositive'];?></td>
       <td><?php echo $rows['caseactive'];?></td>
        <td><?php echo $rows['casedied'];?></td>
       <td><?php echo $rows['discharged'];?></td>
