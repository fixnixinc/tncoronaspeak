    ...
    $secretkey=$_POST['secretkey'];
     ...
     $result=mysqli_query($link,$sql);
             ...
             {    
               ...
               {
                alert("Enter Correct Tip Number and Secret Code");
...
<base href="/tncorona/"><!--end::Base Path -->
        ...
        <title>Corona Speak | FollowUp Case</title>
        <meta name="description" content="We Provide Follow up cases for affected by corona using Case Number and Secret key. The method is very helpful for find status about corona affected people">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="keyword" content="Corona cases | Corona | Corona Folloup case | Corona Virus Followup">
        <link rel="canonical" href="https://www.coronaspeak.com/tncorona/caselogin.php" />
