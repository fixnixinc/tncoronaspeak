...
$sql = "SELECT `secretkey`,`ran` from `logostics` order by id DESC limit 1";
...
<!--                 <div class="" style="text-align: center;font-size: 20px;"><strong>WhistleBlower - Remember this is for future use</strong></div> -->
              <div class="modal-body">
               <div class="form-group">
                <label style="font-size: 20px;"><b>Track Number</b></label><br>
 ...
 <div class="form-group">
              <label style="font-size: 20px;"><b>Track code</b></label><br>
