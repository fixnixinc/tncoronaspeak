...
<div class="form-group">
  <label style="font-size: 14px;"><b>Brief note on assistance :</b></label>
      <div class="">
...
<div class="container">
<div class="form-group">
  <label style="font-size: 14px;"><b>DCMO Remarks From Call Center:</b></label>
      <div class="">
   ...
   <div class="form-group">
  <label style="font-size: 14px;"><b>DCMO Resolution Update:</b></label>
      <div class="">
   <textarea type="text" class="form-control" disabled placeholder="Give WhistleBlower on update"  style="height: 150px; border-color:#A1E6EA"><?php echo $rows['resolution'];?> </textarea>
   <span id="apdate" style="color: red;"></span>
</div>
   </div>

      <div class="form-group">
  <label style="font-size: 14px;"><b>DCMO Detailed Analysis:</b></label>
      <div class="">
   <textarea type="text" class="form-control" disabled placeholder="Give WhistleBlower on update"  style="height: 150px; border-color:#A1E6EA"><?php echo $rows['reinvestigate'];?> </textarea>
   <span id="apdate" style="color: red;"></span>
</div>
   </div>

   <div class="form-group">
  <label style="font-size: 14px;"><b>Attachment</b></label>
      <div class="">
