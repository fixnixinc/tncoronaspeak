...
Requirement - <?php echo substr($_GET['id'], 0, 4) . "  " . substr($_GET['id'], 4, 4) . "  " . substr($_GET['id'],8,4) . "  " . substr($_GET['id'], 12, 4); ?>
</h3>
</div>        
</div>
...
<!--    <div class="form-group">
  <label style="font-size: 14px;"><strong> Update to citizen:</strong></label> 
   ...
   <div class="form-group">
  <label style="font-size: 14px;"><strong>Remarks to DCMO :</strong></label> 
      <div class="">
...
<script type="text/javascript">
  function alert()
  {
    Swal.fire("Requirement Analysed and sent to DCMO.");
  }
</script>
